...
static KING_LOST_CAS_RIGHTS_PEN: i32 = -60;
...
static CANDIDATE_PASSED_PAWN_KING_DISTANCE_BASE_PEN: i32 = -6;
...
pub fn eval_state(state: &State, material_score: i32) -> i32 {
    ...
    let midgame_positional_score =
        ...
        + w_features_map.king_exposure_count * KING_EXPOSED_PEN
        ...
        - b_features_map.king_exposure_count * KING_EXPOSED_PEN
